...
//            var_dump($ehMobile); exit();
        ...
        $noticia = $this->Noticias->find()->where(['Noticias.id' => $id])->contain('Categorias')->first();

       // debug($noticia); exit();

        $this->loadModel('NoticiaRelacionadas');
        $relacionados = $this->NoticiaRelacionadas->find()->where([ 'noticia_id' => $noticia->id ])->contain(['Noticias' => 'Categorias'])->toArray();
