            ...
            <div class="modal-body">
                <div class="widget">
                    ...
                    <div class="subscribe--widget">
                        ...
                        <textarea style="width: -webkit-fill-available; margin-top: 20px;background: #fff; border: none;" class="single-textarea input-anuncie" name="mensagem" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mensagem" required=""></textarea>
