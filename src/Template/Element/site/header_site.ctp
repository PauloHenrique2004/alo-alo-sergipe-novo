                ...
                <div class="header--logo float--left float--sm-none text-sm-center">
                    <h1 class="h1">
                        <a href="home-1.html" class="btn-link">
                            <img src="/images/logo.png" alt="USNews Logo">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="home-menu-v3.html">Home Menu V3</a></li>
                                            ...
                                            <div class="megamenu--posts" data-ajax-content="outer">
                                                <ul class="row" data-ajax-content="inner">
                                                    <li class="col-md-3">
                                                        <div class="img">
                                                            <a href="news-single-v1.html" class="thumb">
                                                                <img src="/images/megamenu-img/post-01.jpg" alt="">
                                                            </a>
                                                    ...
                                                    <li class="col-md-3">
                                                        <div class="img">
                                                            <a href="news-single-v1.html" class="thumb">
                                                                <img src="/images/megamenu-img/post-02.jpg" alt="">
                                                            </a>
                                                    ...
                                                    <li class="col-md-3">
                                                        <div class="img">
                                                            <a href="news-single-v1.html" class="thumb">
                                                                <img src="/images/megamenu-img/post-03.jpg" alt="">
                                                            </a>
                                                    ...
                                                    <li class="col-md-3">
                                                        <div class="img">
                                                            <a href="news-single-v1.html" class="thumb">
                                                                <img src="/images/megamenu-img/post-04.jpg" alt="">
                                                            </a>
