        ...
        <div class="box box-primary">
          ...
          <?php echo $this->Form->create($blog, ['type' => 'file']); ?>
            <div class="box-body">
              ...
              echo "<span style='color: red; margin-top: -15px; position: absolute'>Dimensões recomendas 800 x 600px</span><br>";
                  echo $this->Form->control('data', ['type' => 'string', 'class' => 'form-control string-date', 'value' => $blog->data->i18nFormat('yyyy-MM-dd')]);
              ?>
            </div>
            <!-- /.box-body -->
