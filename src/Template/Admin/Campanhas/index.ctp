              ...
              <?php foreach ($campanhas as $campanha): ?>
                <tr>
                  ...
                  <td class="actions text-right">
                      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $campanha->id], ['class'=>'btn btn-warning']) ?>
                      <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $campanha->id], ['confirm' => __('Você tem certeza que quer deletar'), 'class'=>'btn btn-danger']) ?>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
